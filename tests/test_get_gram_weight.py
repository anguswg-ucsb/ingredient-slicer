...
#     gram_weight     = round(gram_weights["gram_weight"]) if gram_weights["gram_weight"] else None
#     min_gram_weight = round(gram_weights["min_gram_weight"]) if gram_weights["min_gram_weight"] else None
#     max_gram_weight = round(gram_weights["max_gram_weight"]) if gram_weights["max_gram_weight"] else None
