...
from ingredient_slicer import _utils, IngredientTools
# -------------------------------------------------------------------------------
# -------------------------------------------------------------------------------
...
def test_find_and_remove_units_pattern(tools):

    pattern = tools.UNITS_PATTERN
...
def test_find_and_remove_all_numbers_pattern(tools):
    pattern = tools.ALL_NUMBERS
...
def test_find_and_remove_prep_words_pattern(tools):
    pattern = tools.PREP_WORDS_PATTERN
...
def test_find_and_remove_words_ending_in_ly_pattern(tools):
    pattern = tools.WORDS_ENDING_IN_LY
    assert _utils._find_and_remove("1 cup of flour", pattern) == '1 cup of flour'
    assert _utils._find_and_remove("brocolli", pattern) == "brocolli"
    assert _utils._find_and_remove("brocolli stalks", pattern) == "brocolli stalks"
    assert _utils._find_and_remove("brocolli florets", pattern) == "brocolli florets"
